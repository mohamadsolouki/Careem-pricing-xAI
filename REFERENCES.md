# Confirmed Academic References — XPrice Project
## MIT 622 Final Project | Group 1

All references below are verified as existing publications.  
Organized by the paper section they support.

---

## FOUNDATIONAL XAI METHODS

**[R1] Lundberg, S. M., & Lee, S. I. (2017).**  
A unified approach to interpreting model predictions.  
*Advances in Neural Information Processing Systems (NeurIPS), 30*, 4765–4774.  
→ Original SHAP paper. The core methodological foundation. Cite in Sections 2 (Literature Review) and 4 (Framework).

**[R2] Ribeiro, M. T., Singh, S., & Guestrin, C. (2016).**  
...
→ Most recent peer-reviewed comparison of SHAP vs LIME. Cite in Section 2 (Literature Review) and Section 4 (justifying SHAP choice).

**[R4] Arrieta, A. B., et al. (2020).**  
Explainable Artificial Intelligence (XAI): Concepts, taxonomies, opportunities and challenges toward responsible AI.  
*Information Fusion, 58*, 82–115. Elsevier.  
→ The canonical XAI survey (3,000+ citations). Provides theoretical taxonomy of XAI methods. Cite in Section 2 (Literature Review).
...
→ Theoretical framework for XAI decision-making. Cite in Section 2.
...
**[R10] Zeithammer, R. (2024).**  
Algorithmic pricing: Implications for consumers, managers, and regulators.  
*UCLA Anderson Review / NBER Working Paper 32540.*  
https://anderson-review.ucla.edu/wp-content/uploads/2024/08/Algo-Pricing-zeithammer.pdf  
→ Comprehensive academic treatment of algorithmic pricing from a manager lens. Cite in Sections 1 and 2.
...
→ Supply-demand dynamic pricing model. Cite in Section 2 for pricing mechanism background.
...
**[R17] Peffers, K., Tuunanen, T., Rothenberger, M. A., & Chatterjee, S. (2007).**  
A design science research methodology for information systems research.  
*Journal of Management Information Systems, 24*(3), 45–77.  
https://dl.acm.org/doi/10.2753/MIS0742-1222240302  
→ The foundational DSR methodology paper. This justifies the research approach: problem → design → artifact → evaluation. Cite in Section 3 (methodology).

---

## PRIOR WORK (GROUP CASE & PROJECT — Internal References)

**[R18] Careem Engineering. (2020).**  
YODA: Scaling machine learning @ Careem. Medium.  
https://medium.com/careem-tech/yoda-scaling-machine-learning-careem-d4bc8b1be195

**[R19] AWS Machine Learning Blog. (2022).**  
How Careem is detecting identity fraud using graph-based deep learning and Amazon Neptune.  
https://aws.amazon.com/blogs/machine-learning/how-careem-is-detecting-identity-fraud-using-graph-based-deep-learning-and-amazon-neptune/

**[R20] e&. (2026).**  
e& delivers record revenue and net profit in FY 2025.  
https://www.eand.com/en/news/24-feb-26-eand-delivers-record-revenue-and-net-profit-in-FY-2025.html

**[R21] WTW. (2024).**  
MENA rideshare industry: Understanding growth, optimizing profitability.  
https://www.wtwco.com/en-eg/insights/2024/09/mena-rideshare-industry-understanding-growth-optimizing-profitability
...
| Category | Count |
|----------|-------|
| Foundational XAI Methods | 4 |
| XAI in DSS & Management | 3 |
| Algorithmic Pricing & Trust | 3 |
| Ride-Hailing ML & Pricing | 4 |
| Regulatory & Compliance | 2 |
| Research Methodology | 1 |
| Prior Work (internal) | 4 |
| **Total Academic References** | **17** |
| **Minimum Required** | **8–10** ✓ |

---

## APA FORMATTING NOTES
- Use Mendeley or Zotero to auto-format all references in APA 7th edition
- For ResearchGate / preprint sources, verify DOI before submission
